...
* R19：管理员可创建活动，包含标题、封面、时间、地点、详情、人数限制等字段，创建时自动记录创建者
* R20：封面上传（可选实现）

**编辑活动**

* R21：管理员只能修改自己创建的活动信息
* R22：管理员只能对自己创建的活动进行上下线操作
* R21.1：尝试编辑或删除其他管理员创建的活动时，系统返回 403 权限错误

**活动列表**

* R23：管理员查看活动列表时，默认只显示自己创建的活动
